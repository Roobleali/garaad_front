...
import type { UserProgress, UserReward, LeaderboardEntry, UserRank } from "@/services/progress";
...
export default function DashboardPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const [progressData, rewardsData, leaderboardData, userRankData, practiceSetsData] = await Promise.all([
