...
const weeks: Week[] = [
    {
        number: 1,
        title: "Idea to MVP Blueprint",
        hours: "10-12 hours",
        difficulty: "Beginner",
        win: "A validated SaaS idea with clear target market",
        skills: [
        ...
        actions: [
            "Identify 3 problems you can solve with software",
            "Interview 10 potential customers",
            "Analyze 5 competitors in your niche",
            "Create your MVP feature list (max 5 features)",
        ],
    },
    {
        number: 2,
        ...
        win: "A working prototype with core functionality",
        skills: [
    ...
    },
    {
        ...
        hours: "12-15 hours",
        difficulty: "Intermediate",
        win: "AI-powered features that wow users",
        skills: [
            "AI API integration",
            "Prompt engineering",
    ...
    {
        number: 4,
        title: "Launch & Get First Users",
        hours: "10-12 hours",
        difficulty: "Intermediate",
        win: "Live product with 10+ beta users",
        skills: [
        ...
        actions: [
            ...
            "Launch on Product Hunt or similar",
            "Onboard and support first 10 users",
        ],
    },
    {
        number: 5,
        ...
        hours: "12-15 hours",
        difficulty: "Advanced",
        win: "First paying customer and growth plan",
        skills: [
            "Pricing strategy",
            "Payment integration",
            "Growth marketing",
        ...
        actions: [
            ...
            "Convert 3 beta users to paying customers",
            "Build referral or viral loop",
            "Create 30-day growth roadmap",
        ],
    },
];
