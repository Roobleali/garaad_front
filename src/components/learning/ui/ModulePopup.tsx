...
export default function ModulePopup({
  ...
  return (
    <div className="absolute top-0 -ml-10 md:ml-0 left-1/2 transform -translate-x-[20%] translate-y-[calc(100%+55px)] w-80 bg-white rounded-lg shadow-lg p-4 z-20 animate-fadeIn border-2 border-border">
