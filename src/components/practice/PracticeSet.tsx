...
import { PracticeSet as IPracticeSet, PracticeSetProblem } from "@/services/lessons";
...
export const PracticeSet: React.FC<PracticeSetProps> = ({ practiceSet, onSubmit }) => {
                                    ...
                                    <div className="space-y-2">
                                        {problem.problem_details.options.map((option, index) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    state?.isSubmitted && {
                                                        "border-green-500 bg-green-50":
                                                            option ===
                                                            problem.problem_details.correct_answer,
                                                ...
                                                onClick={() =>
                                                    handleAnswerSelect(problem, option)
                                                }
