...
export const SignatureCalculator: React.FC<SignatureCalculatorProps> = ({
  ...
  const { n, g, sk, m } = config
    ? extractCalculatorConfig(config)
    : {
        n: propN ?? 29,
        g: propG ?? 17,
        sk: defaultSk ?? 35,
    ...
    >
      ...
      >
        <div style={{ marginRight: 30, textAlign: "center" }}>
          ...
          <input
            style={{ ...defaultStyles.input, width: 80 }}
            value={n}
            disabled
          />
        </div>
      ...
      <div style={{ display: "flex", flexGrow: 1, marginBottom: 15 }}>
        ...
        <div style={{ ...defaultStyles.section, marginRight: 10 }}>
          ...
          <input
            ...
            value={skState}
            onChange={(e) =>
              setSk(e.target.value === "" ? "" : Number(e.target.value))
            }
          />
        ...
        <div style={{ ...defaultStyles.section, marginLeft: 10 }}>
          ...
          <input
            ...
            value={mState}
            onChange={(e) =>
              setM(e.target.value === "" ? "" : Number(e.target.value))
            }
          />
      ...
      >
        ...
        >
          ...
          <input
            ...
            readOnly
          />
          <button style={defaultStyles.button} onClick={checkPkm}>
            HUBI
          </button>
        </div>
        <div
        ...
        >
          ...
          <input
            ...
            readOnly
          />
          <button style={defaultStyles.button} onClick={checkSigg}>
            HUBI
          </button>
        </div>
      </div>
