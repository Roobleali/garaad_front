...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' blob: data: res.cloudinary.com api.garaad.org localhost:8000 127.0.0.1:8000 images.ctfassets.net *.posthog.com https://*.stripe.com https://img.youtube.com https://www.transparenttextures.com;
